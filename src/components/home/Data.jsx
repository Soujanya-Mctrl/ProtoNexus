const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Soujanya Mallick
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Programming Enthusiast</h3>
            <p className="home__description"> Hi! I am a programming beginner with a passion for learning and building. Excited to explore hackathons and grow through hands-on projects.</p>
            <a href="#contact" className="button button__flex" >Say Hello
                <svg
                    class="button__icon"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
